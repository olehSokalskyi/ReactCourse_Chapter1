...
function App() {
    ...
    const {toDoList, searchTerm, toDo, handleSearchChange, handleChange, handleDelete, handleAddToDo } = useToDoList(toDoListExample);
    return (
        <>
            <div>
                <div>
                    <ToDoSearchInput searchTerm={searchTerm} handleSearchChange={handleSearchChange} />
                </div>
                <div>
                    <ToDoTable toDoList={toDoList} handleDelete={handleDelete}/>
                </div>
                <div>
                    <ToDoForm toDo={toDo} handleAddToDo={handleAddToDo} handleChange={handleChange}/>
                </div>
